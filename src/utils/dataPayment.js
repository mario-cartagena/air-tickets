...
export const paymentCredit = [
    ...
    {id: 2, image: paypal, alt: 'Logo PayPal'},
    {id: 3, image: invex, alt: 'Logo Tarjeta de Crédito Invex'},
    {id: 4, image: mastercard, alt: 'Logo Tarjeta de Crédito MasterCard'},
    {id: 5, image: visa, alt: 'Logo Tarjeta de Crédito Visa'},
];

export const paymentCash = [
    {id: 1, image: oxxo, alt: 'Logo Oxxo'},
    {id: 2, image: seven, alt: 'Logo SevenEleven'},
    {id: 3, image: walmart, alt: 'Logo Walmart'},
    {id: 4, image: famaAhorro, alt: 'Logo FarmaAhorro'},
];